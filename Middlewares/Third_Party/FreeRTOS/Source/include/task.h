...
typedef struct pointers_struct {
    void * point_pxReadyTasksLists;
    void * point_pxDelayedTaskList;
//  void * point_DelayedTaskList_priority;
    void * point_xPendingReadyList;
    void * point_uxTopReadyPriority;
    void * point_xSchedulerRunning;
    void * point_uXPriority;
} Pointer_to_SRAM;
